  ...
  return (
    ...
    <div className="container-fluid">
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        {/* now updated buttons is created. */}
        ...
        {/* Exercise : made by me for color button */}
        {/* <button type="button " onClick={props.togglecolor} className="btn btn-outline-danger">{props.pmode === "pink"?"Enable Pinkmode":"Enable Whitemode"}</button> */}
